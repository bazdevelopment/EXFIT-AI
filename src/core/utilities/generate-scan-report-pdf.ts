...
<body>
    <div class="container">
        <!-- Header -->
        <div class="header">
            <img src=${logo} alt="MicroScan AI Logo" class="logo">
            <div class="branding-text">
                <p style="font-size: 25px; line-height: 0px; font-weight: 800; letter-spacing: 1px;">MicroScan AI</p>
            </div>
        </div>
        ...
        <footer style="text-align: center; padding: 20px; color: #64748B; font-size: 12px; border-top: 1px solid #E2E8F0; margin-top: 100px;">
            <p style="margin: 0;">Generated by MicroScan AI • ${createdAt}</p>
            <p style="margin: 0;">The AI-generated results from MicroScan AI are intended for informational purposes only and should not be used as a substitute for professional advice. Always seek guidance from a qualified healthcare professional for diagnosis and treatment.</p>
        </footer>
    </div>
</body>
</html>
