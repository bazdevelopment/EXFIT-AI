...
export const TabBarIcon = ({
  ...
  return (
    <Animated.View
      ...
      className={`size-[60] flex-col items-center justify-center  gap-2 rounded-full p-2 ${focused ? 'bg-black' : !focused && isScanScreen ? 'bg-[#3195FD]' : 'bg-black'} ${isScanScreen ? '-top-8 size-[80]' : 'top-2'} ${DEVICE_TYPE.IOS ? 'mt-8' : 'mt-8'}`}
    >
      {icon}
