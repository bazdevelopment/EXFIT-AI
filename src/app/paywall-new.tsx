...
import { type IOnboardingCollectedData } from './onboarding-first';
  ...
  >
    <View className="flex-row items-center justify-between">
      <View className="flex-1">
        ...
        <View>
          {originalPrice && (
            <View className="mt-1 flex-row">
              <Text className="mr-2 font-semibold-poppins text-base text-gray-400 line-through">
                {originalPrice}
              </Text>
              <Text className="font-semibold-poppins text-base text-gray-900">
        ...
        {subtitle && (
          <Text className="text-md font-primary-poppins text-charcoal-900">
            {subtitle}
          </Text>
        )}
      </View>
      ...
      <SafeAreaView className="flex-1">
        ...
        >
          ...
          <View className="-mt-4 px-6">
            ...
            {/* Features */}
            <View className="mb-8 w-[95%] items-center justify-center self-center">
